...
const IndexPage = () => (
  <Layout>
    ...
    <section id="banner">
      ...
      <div class="anim_wrapping container-fluid">
        <div class="anim">
      ...
      <div class="inner">
        ...
        >
          ...
          <section>
            <div class="content">
              <header>
                <a href="#" class="icon fa-cloud-download"
                  ><span class="label">Icon</span></a
                >
    ...
    <section class="wrapper">
      <div class="inner">
        <header class="special" data-aos="fade-left">
